"use strict";
exports.validateObject = validate11;
const schema28 = {"$id":"personForm.json","$schema":"http://json-schema.org/draft-07/schema","title":"Person Form","description":"Person Form with repeat password","type":"object","allOf":[{"$ref":"person.json"},{"properties":{"repeatPassword":{"type":"string","const":{"$data":"/password"}}},"required":["repeatPassword"]}]};
...
function validate11(data, {dataPath="", parentData, parentDataProperty, rootData=data}={}){
/*# sourceURL="personForm.json" */;
let vErrors = null;
let errors = 0;
...
const err18 = {keyword:"required",dataPath,schemaPath:"#/allOf/1/required",params:{missingProperty: "repeatPassword"},message:"should have required property '"+"repeatPassword"+"'"};
if(vErrors === null){
vErrors = [err18];
}
else {
...
if(data.repeatPassword !== undefined){
let data4 = data.repeatPassword;
const _errs11 = errors;
if(typeof data4 !== "string"){
const err19 = {keyword:"type",dataPath:dataPath+"/repeatPassword",schemaPath:"#/allOf/1/properties/repeatPassword/type",params:{type: "string"},message:"should be string"};
if(vErrors === null){
vErrors = [err19];
}
else {
...
const vSchema1 = rootData && rootData.password;
if(vSchema1 !== undefined && (!func0(data4, vSchema1))){
const err20 = {keyword:"const",dataPath:dataPath+"/repeatPassword",schemaPath:"#/allOf/1/properties/repeatPassword/const",params:{allowedValue: vSchema1},message:"should be equal to constant"};
if(vErrors === null){
vErrors = [err20];
}
else {
